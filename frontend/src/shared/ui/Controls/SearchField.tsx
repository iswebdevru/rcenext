    ...
    return (
      ...
      >
        <FontAwesomeIcon
          ...
          fixedWidth
          size="xs"
          className="text-zinc-400 transition-colors group-focus-within/search:text-blue-500 dark:text-zinc-500 dark:group-focus-within/search:text-blue-600"
        />
        <input
          {...props}
          ref={ref}
          className="min-w-0 flex-grow border-none bg-transparent outline-none placeholder:text-zinc-400 dark:placeholder:text-zinc-500"
        />
      </div>
    );
  },
