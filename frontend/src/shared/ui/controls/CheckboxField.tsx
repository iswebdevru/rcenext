    ...
    return (
      <label className="flex items-center gap-3 px-2 py-1">
        ...
        <div
          className={clsx(
            className,
            'dark:ring- grid h-5 w-5 place-items-center rounded-md border border-zinc-200 fill-inherit text-transparent ring-primary-500 peer-checked:border-primary-500 peer-checked:bg-primary-50 peer-checked:text-primary-500 peer-focus-visible:ring-2 hover:border-zinc-400 dark:border-zinc-700 dark:ring-zinc-200 dark:peer-checked:border-transparent dark:peer-checked:bg-primary-600 dark:peer-checked:text-white hover:dark:border-zinc-500',
          )}
        >
