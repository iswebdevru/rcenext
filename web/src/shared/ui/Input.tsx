  ...
  return (
    <input
      ...
      className={classNameWithDefaults(
        clsx({
          'transition-[outline,border] text-black dark:text-slate-200 bg-white outline outline-blue-200 outline-0 h-8 rounded-md text-sm border border-slate-200 px-3 py-1 w-full focus:outline-4 focus:border-blue-500 dark:bg-slate-800 dark:border-slate-700 dark:focus:border-blue-700 dark:outline-blue-700':
            true,
